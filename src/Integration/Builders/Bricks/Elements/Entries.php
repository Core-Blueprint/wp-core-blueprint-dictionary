...
final class Entries extends \Bricks\Element {
	...
	public function set_controls(): void {
		...
		$this->controls['listFlexWrap'] = [
			...
			'inline'   => true,
			'css'      => [ [ 'property' => 'flex-wrap', 'selector' => '.cb-dictionary-list__items' ] ],
		...
		$this->controls['listDirection'] = [
			...
			'inline'   => true,
			'rerender' => true,
			'css'      => [ [ 'property' => 'flex-direction', 'selector' => '.cb-dictionary-list__items' ] ],
			'required' => [ 'listDisplay', '=', 'flex' ],
		];
		$this->controls['listJustifyContent'] = [
			...
			'css'      => [ [ 'property' => 'justify-content', 'selector' => '.cb-dictionary-list__items' ] ],
			'required' => [ 'listDisplay', '=', 'flex' ],
		];
		$this->controls['listAlignItems'] = [
			...
			'type'     => 'align-items',
			'css'      => [ [ 'property' => 'align-items', 'selector' => '.cb-dictionary-list__items' ] ],
			'required' => [ 'listDisplay', '=', 'flex' ],
		];
		$this->controls['listColumnGap'] = [
			...
			'type'     => 'number',
			'units'    => true,
			'css'      => [ [ 'property' => 'column-gap', 'selector' => '.cb-dictionary-list__items' ] ],
			'required' => [ 'listDisplay', '=', 'flex' ],
		];
		$this->controls['listRowGap'] = [
			...
			'type'     => 'number',
			'units'    => true,
			'css'      => [ [ 'property' => 'row-gap', 'selector' => '.cb-dictionary-list__items' ] ],
			'required' => [ 'listDisplay', '=', 'flex' ],
		];
